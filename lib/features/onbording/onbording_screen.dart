...
class Onbording_screen extends StatefulWidget {
  @override
  State<Onbording_screen> createState() => _MyScreenState();
}

class _MyScreenState extends State<Onbording_screen> {
          ...
          children: [
            ...
            ElevatedButton(
              ...
              onPressed: () {
                ...
                print("pageNamber onPressed $pageNamber");
              },
              child: Text(pageNamber == 3 ? "НАЧАТЬ"
                  : "ДАЛЕЕ",
                  style: TextStyle(
                      color: Colors
